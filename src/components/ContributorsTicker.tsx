...
export default function ContributorsTicker() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-card px-4 py-1.5 flex items-center gap-3">
      ...
      <div className="flex items-center gap-3 overflow-x-auto">
        {contributors.map((c) => (
          <a
            key={c.handle}
            href={`https://github.com/LemhiCo/MSP-AI-Framework/issues?q=is%3Aissue%20author%3A${c.handle.replace('@', '')}`}
            target="_blank"
